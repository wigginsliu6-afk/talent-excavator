...
var FOLLOW_UPS=['我感觉这里面还有更深的东西。能举一个最具体的例子吗？','我注意到你的描述中有一个矛盾点——你能展开说说吗？','你提到的这个点很关键，但我好奇：为什么是这件事，而不是别的？','你的回答让我捕捉到一个模式。在你最近的生活中，这种感觉还出现过吗？','有意思——你的潜意识好像在回避什么。能再想想那个时刻你的身体反应吗？'];
